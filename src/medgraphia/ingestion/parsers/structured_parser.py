...
from medgraphia.domain import RawDocument, SourceMeta, Language, ParsedSection
...
class StructuredParser:
    ...
    def parse_huatuo(self, file_path: Path) -> Iterable[RawDocument]:
        ...
        with open(file_path, "r", encoding="utf-8") as f:
            for line in f:
                ...
                if related:
                    sections.append(ParsedSection(section_path="Related Diseases", title="Related Diseases", content=related))
    ...
    def parse_germed(self, file_path: Path) -> Iterable[RawDocument]:
        ...
        for item in data_list:
            ...
            sections = [
                ParsedSection(section_path="Clinical Description", title="German Text", content=de_text)
            ]
            if en_text:
                sections.append(ParsedSection(section_path="English Translation", title="English Translation", content=en_text))
