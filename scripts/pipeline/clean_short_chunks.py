...
from both Qdrant (vector store) and Neo4j (graph database).
...
async def main():
    ...
    try:
        ...
        logger.info(f"Scan complete. Total chunks: {total_processed}, Junk chunks found: {len(junk_ids)}")
        ...
        logger.info("Cleanup process finished successfully! Knowledge Graph entities remain intact.")
